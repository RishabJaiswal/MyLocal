...
public class Rwheel extends ImageView  {
  ...
  public Rwheel(Context context) {
    super(context);
    initialize();
  }
  
  public Rwheel(Context context, AttributeSet attrs)
  {
    super(context, attrs);
    initialize();
  }
  
  public Rwheel(Context context, AttributeSet attrs, int defStyle)
  {
