...
public class Huffman {
    ...
    public static int noCompd=0;

    public static void doEverything(String input) throws FileNotFoundException {
        // Read all the contents of the file
        String text = new Scanner(new File(input)).useDelimiter("\\A").next(); // nextLine(); // change it if you only want to read a single line without the new line character.
    ...
    public static void saveToFile(String l) throws FileNotFoundException {
        ...
        //Log.e("Saving Image : ", Utils.directory.getAbsolutePath());
        PrintWriter oFile = new PrintWriter(new File(Utils.directory.getPath(), "data"+ noCompd + ".txt"));
